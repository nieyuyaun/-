        ...
        <div class="content_body">
          ...
          <div class="content-body_bottom">
            ...
            <div v-if="$store.state.Rshow" class="content_detail">
              <Detail @dellist="dellist"></Detail>
            </div>
            <div v-if="!$store.state.Rshow" class="content_edit">
              <Edit @sxlist="sxlist"></Edit>
            </div>
...
import List from "@/components/ershou/list"
import Edit from "@/components/ershou/edit"
import Detail from "@/components/ershou/detail"
...
export default {
  ...
  store,
  components:{
    Reserch,List,Edit,Detail,Menu,Header,My
  },
  mounted: function () {
    this.getCookies();
  },
